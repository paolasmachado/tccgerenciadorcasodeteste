<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListagemEstoriaDeUsuario.aspx.cs" Inherits="Paginas_ListagemEstoriaDeUsuario" %>
                            ...
                            <div class="dataTable_wrapper">
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    <form id="form1" runat="server">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <asp:Button ID="BotaoAdicionarHistoriaDeUsuario" runat="server" Text="Adicionar Estória de usuário" class="btn btn-default" OnClick="BotaoAdicionarHistoriaDeUsuario_Click1" />
                                            </div>
                                            <div class="col-sm-6">
